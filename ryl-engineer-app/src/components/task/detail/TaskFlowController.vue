...
// 任务类型对应的流程步骤定义
const TASK_TYPE_FLOW_STEPS = {
  // 仪器维修流程
  'repair': [
    { id: 'accepted', title: '已接单', status: 'pending' },
    { id: 'site-visit-decision', title: '判断是否需要上门', status: 'pending' },
    { id: 'inspection-complete', title: '检修完成', status: 'pending' },
    { id: 'repair-plan', title: '维修方案和报价', status: 'pending' },
    { id: 'repairing', title: '维修中', status: 'pending' },
    { id: 'verification-report', title: '验证报告', status: 'pending' },
    { id: 'service-evaluation', title: '服务评价', status: 'pending' },
    { id: 'completed', title: '订单已完成', status: 'pending' }
  ],
  ...
  'maintenance': [
    ...
    { id: 'site-visit-decision', title: '判断是否需要上门', status: 'pending' },
    { id: 'inspection-complete', title: '检修完成', status: 'pending' },
    { id: 'maintenance-plan', title: '保养方案和报价', status: 'pending' },
    { id: 'maintaining', title: '保养中', status: 'pending' },
    { id: 'verification-report', title: '验证报告', status: 'pending' },
    { id: 'service-evaluation', title: '服务评价', status: 'pending' },
    { id: 'completed', title: '订单已完成', status: 'pending' }
  ],
  ...
  'recycle': [
    { id: 'accepted', title: '已接单', status: 'pending' },
    { id: 'site-visit-decision', title: '判断是否需要上门', status: 'pending' },
    { id: 'inspection-complete', title: '检查完成', status: 'pending' },
    { id: 'recycle-plan', title: '回收方案和报价', status: 'pending' },
    { id: 'recycling', title: '回收中', status: 'pending' },
    { id: 'verification-report', title: '验证报告', status: 'pending' },
    { id: 'service-evaluation', title: '服务评价', status: 'pending' },
    { id: 'completed', title: '订单已完成', status: 'pending' }
  ],
  ...
  'rental': [
    ...
    { id: 'site-visit-decision', title: '判断是否需要上门', status: 'pending' },
    { id: 'inspection-complete', title: '检查完成', status: 'pending' },
    { id: 'rental-plan', title: '租赁方案和报价', status: 'pending' },
    { id: 'renting', title: '租赁中', status: 'pending' },
    { id: 'verification-report', title: '验证报告', status: 'pending' },
    { id: 'service-evaluation', title: '服务评价', status: 'pending' },
    { id: 'completed', title: '订单已完成', status: 'pending' }
  ],
  ...
  'training': [
    { id: 'accepted', title: '已接单', status: 'pending' },
    { id: 'site-visit-decision', title: '判断是否需要上门', status: 'pending' },
    { id: 'preparation-complete', title: '培训准备完成', status: 'pending' },
    { id: 'training-plan', title: '培训方案和报价', status: 'pending' },
    { id: 'training-in-progress', title: '培训中', status: 'pending' },
    { id: 'verification-report', title: '验证报告', status: 'pending' },
    { id: 'service-evaluation', title: '服务评价', status: 'pending' },
    { id: 'completed', title: '订单已完成', status: 'pending' }
  ],
  ...
  'verification': [
    { id: 'accepted', title: '已接单', status: 'pending' },
    { id: 'site-visit-decision', title: '判断是否需要上门', status: 'pending' },
    { id: 'preparation-complete', title: '验证准备完成', status: 'pending' },
    { id: 'verification-plan', title: '验证方案和报价', status: 'pending' },
    { id: 'verifying', title: '验证中', status: 'pending' },
    { id: 'verification-report', title: '验证报告', status: 'pending' },
    { id: 'service-evaluation', title: '服务评价', status: 'pending' },
    { id: 'completed', title: '订单已完成', status: 'pending' }
  ],
  ...
  'selection': [
    { id: 'accepted', title: '已接单', status: 'pending' },
    { id: 'site-visit-decision', title: '判断是否需要上门', status: 'pending' },
    { id: 'analysis-complete', title: '选型分析完成', status: 'pending' },
    { id: 'selection-plan', title: '选型方案和报价', status: 'pending' },
    { id: 'selecting', title: '选型进行中', status: 'pending' },
    { id: 'verification-report', title: '验证报告', status: 'pending' },
    { id: 'service-evaluation', title: '服务评价', status: 'pending' },
    { id: 'completed', title: '订单已完成', status: 'pending' }
  ],
  ...
  'installation': [
    { id: 'accepted', title: '已接单', status: 'pending' },
    { id: 'site-visit-decision', title: '判断是否需要上门', status: 'pending' },
    { id: 'preparation-complete', title: '安装准备完成', status: 'pending' },
    { id: 'installation-plan', title: '安装方案和报价', status: 'pending' },
    { id: 'installing', title: '安装中', status: 'pending' },
    { id: 'verification-report', title: '验证报告', status: 'pending' },
    { id: 'service-evaluation', title: '服务评价', status: 'pending' },
    { id: 'completed', title: '订单已完成', status: 'pending' }
  ]
