<template>
  <view class="p-4">
    <view class="flex items-center mb-4">
      ...
      <view class="text-xl font-medium">个人资料</view>
    </view>
    ...
    <form @submit="saveProfile" class="mt-4">
      ...
      <!-- 姓名 -->
      <view class="mb-4">
        <view for="name" class="block text-sm font-medium text-gray-700 mb-1">姓名 <text class="text-red-500">*</text></view>
        <input 
          id="name"
      ...
      <!-- 公司名称 -->
      <view class="mb-4">
        <view for="company" class="block text-sm font-medium text-gray-700 mb-1">公司名称 <text class="text-red-500">*</text></view>
        <input 
          id="company"
      ...
      <!-- 联系电话 -->
      <view class="mb-4">
        <view for="phone" class="block text-sm font-medium text-gray-700 mb-1">联系电话 <text class="text-red-500">*</text></view>
        <input 
          id="phone"
      ...
      <!-- 联系地址 -->
      <view class="mb-4">
        <view for="address" class="block text-sm font-medium text-gray-700 mb-1">联系地址 <text class="text-red-500">*</text></view>
        <input 
          id="address"
      ...
      <!-- 部门 -->
      <view class="mb-4">
        <view for="department" class="block text-sm font-medium text-gray-700 mb-1">部门</view>
        <input 
          id="department"
      ...
      <!-- 职位 -->
      <view class="mb-4">
        <view for="position" class="block text-sm font-medium text-gray-700 mb-1">职位</view>
        <input 
          id="position"
      ...
      <!-- 电子邮箱 -->
      <view class="mb-6">
        <view for="email" class="block text-sm font-medium text-gray-700 mb-1">电子邮箱</view>
        <input 
          id="email"
